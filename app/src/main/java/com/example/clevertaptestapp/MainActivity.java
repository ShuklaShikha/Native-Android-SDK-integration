...
//        CleverTapAPI.getDefaultInstance(this).pushNotificationViewedEvent(null);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                profileUpdate.put("Name", "ss");    // String
                profileUpdate.put("Identity", 101);      // String or number
                profileUpdate.put("Email", "ss2@gmail.com"); // Email address of the user
                profileUpdate.put("Phone", "+987656786");   // Phone (with the country code, starting with +)
